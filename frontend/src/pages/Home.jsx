...
import { FaSignInAlt, FaUserPlus, FaCalendarAlt, FaClock, FaFileAlt, FaChartBar, FaShieldAlt, FaUsers, FaStar, FaQuestionCircle, FaRocket, FaChartLine, FaLink, FaMoneyCheckAlt, FaInfoCircle } from 'react-icons/fa';

const Home = ({ user }) => (
  <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 overflow-hidden">
    {/* Hero Section */}
    <section className="min-h-[80vh] flex items-center justify-center text-center bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20 relative overflow-hidden">
      <div className="px-6 md:px-12 relative z-10">
        ...
        <p className="text-lg md:text-xl max-w-4xl mx-auto text-blue-100 mb-10 animate-slide-up">
    ...
    <section className="py-20 bg-blue-100/60">
      <div className="px-6 md:px-12">
        <h2 className="text-3xl md:text-4xl font-extrabold text-blue-800 tracking-tight text-center mb-12 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          <div className="text-gray-700 text-lg leading-relaxed space-y-6">
            ...
            <p className="animate-slide-right delay-200">
          ...
          <div className="bg-blue-50 p-8 rounded-2xl shadow-xl border border-blue-200 hover:shadow-2xl transition-all duration-300 animate-scale-up">
    ...
    {/* Com Timelix Millora la Productivitat Section */}
    <section className="py-20 bg-white">
      <div className="px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-blue-50 p-6 rounded-2xl shadow-md border border-blue-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-slide-up">
          ...
          <div className="bg-blue-50 p-6 rounded-2xl shadow-md border border-blue-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-slide-up delay-200">
            <div className="flex items-center mb-4">
          ...
          <div className="bg-blue-50 p-6 rounded-2xl shadow-md border border-blue-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-slide-up delay-400">
            <div className="flex items-center mb-4">
    ...
    {/* Integracions i Compatibilitat Section */}
    <section className="py-20 bg-blue-100/60">
      <div className="px-6 md:px-12">
        <h2 className="text-3xl md:text-4xl font-extrabold text-blue-800 tracking-tight text-center mb-12 animate-fade-in">
    ...
    {/* Estadístiques d'Impacte Section */}
    <section className="py-20 bg-white">
      <div className="px-6 md:px-12">
        <h2 className="text-3xl md:text-4xl font-extrabold text-blue-800 tracking-tight text-center mb-12 animate-fade-in">
          El nostre impacte
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-white p-6 rounded-2xl shadow-md border border-blue-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-scale-up text-center">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md border border-blue-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-scale-up delay-200 text-center">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md border border-blue-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-scale-up delay-400 text-center">
    ...
    <section className="py-20 bg-blue-100/60">
      <div className="px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-slide-up">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-slide-up delay-200">
            <div className="flex items-center mb-6">
              <FaMoneyCheckAlt className="text-4xl text-blue-600 mr-5" />
    ...
    {/* Preguntes Freqüents Section */}
    <section className="py-20 bg-blue-100/60">
      <div className="px-6 md:px-12">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-extrabold text-blue-800 tracking-tight animate-fade-in">
            Preguntes Freqüents
          </h2>
    ...
    <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800">
      <div className="px-6 md:px-12 text-center">
        <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight mb-12 animate-fade-in">
          Què diuen els nostres usuaris
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-lg text-blue-700 hover:shadow-2xl transition-all duration-300 animate-slide-up">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg text-blue-700 hover:shadow-2xl transition-all duration-300 animate-slide-up delay-200">
            <FaStar className="text-3xl text-yellow-400 mb-4" />
    ...
    <section className="py-24 bg-gradient-to-r from-blue-600/20 to-blue-800/20 text-center">
      <div className="px-6 md:px-12">
        <h2 className="text-4xl md:text-5xl font-extrabold text-blue-800 mb-6 animate-fade-in">
